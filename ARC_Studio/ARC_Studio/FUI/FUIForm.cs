...
using ARC_Studio.Properties;
using DarkModeForms;

namespace ARC_Studio
{
    public partial class FUIForm : Form
    {
        ...
        {
            Messenger.MessageBox("Save feature still in development!");
            //SaveFui(openedFUI);
        }

        private void OnClickFileSaveAs(object sender, EventArgs e)
        {
            Messenger.MessageBox("Save as feature still in development!");
        ...
        {
            Messenger.MessageBox("Exit feature still in development!\n\n hahahaha just kidding, go and press the button in the top right corner");
        ...
        {
            Messenger.MessageBox("Not available yet");
        ...
        private void OnClickFileSaveAllImages(object sender, EventArgs e)
        {
            ...
            if (fileDialog.ShowDialog() == CommonFileDialogResult.Ok)
            {
                ...
                string filepathBase = Path.Combine(
                    directorySelected, Path.GetFileNameWithoutExtension(openedFUI) + "_{0}{1}");
        ...
        private void OnFormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                e.Cancel = NotifySave();
                RPC.SetArcEditorPresence(openedFUI != null ? Path.GetFileName(openedFUI) : null);
            }
        }
        ...
        private void OnSavedFui(string fille)
        {
            openedFUI = fille;
            shouldSaveFui = false;
            MessageBox.Show(string.Format(Resources.DialogSavedFui, fille));
        }
        ...
        private void SaveFui(string file)
        {
                ...
                File.WriteAllBytes(file, FuiUtils.ProcessHeader(fuiBytes.ToArray()));
        ...
        private void FUIForm_Load(object sender, EventArgs e)
        {
            RPC.SetFUIFormPresence(openedFUI != null ? Path.GetFileName(openedFUI) : null);
        }
    }
}
