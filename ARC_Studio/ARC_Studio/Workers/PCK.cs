...
namespace ARC_Studio.Workers
{
    public class PCK
    {
        ...
        private static void writeMinecraftString(FileOutput f, string value)
        {
            byte[] d = Encoding.Unicode.GetBytes(value);
        ...
        public byte[] Rebuild()
        {
            ...
            foreach (MineFile mf in mineFiles)
            {
                ...
                {
                    System.Windows.MessageBox.Show(missing + " is not in the main metadatabase");
                    break;
                }
            }
