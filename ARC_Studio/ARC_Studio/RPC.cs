...
namespace ARC_Studio
{
    public static class RPC
    {
        ...
        public static class Icons
        {
            ...
            public const string FUIEditor = "fui_editor_icon";
        }           
        ...
        public static void SetLoadingFormPresence(string fileName = null)
        {
            ...
            UpdatePresence("An open-source Editor", state, Icons.Main, "Loading Form");
        }

        public static void SetFUIFormPresence(string fileName = null)
        {
            string state = string.IsNullOrEmpty(fileName)
                ? "An open-source Editor"
                : $"File {Path.GetFileName(fileName)}";

            UpdatePresence("", state, Icons.FUIEditor, "Loading Form");
        }
